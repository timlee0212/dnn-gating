...
config_parser = parser = argparse.ArgumentParser(description='Training Config', add_help=True)
...
if __name__=="__main__":
    ...
    dist_need_bootstrap = config.Experment.dist and "LOCAL_RANK" not in os.environ
    ...
    if dist_need_bootstrap:
        gpu_ids = config.Experment.gpu_ids
